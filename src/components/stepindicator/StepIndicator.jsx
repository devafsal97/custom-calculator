...
const VerticalLinearStepper = ({ calculationData }) => {
  ...
  return (
    <div className="step-indicator">
      {steps.map((step) => {
        if (step.id === 4 && calculationData.paymentOption[index] === "advisor-directed") {
          return null; // Skip the "Configure Strategist Fee" step if paymentOption is "advisor-directed"
        }
        return (
          <div
            key={step.id}
