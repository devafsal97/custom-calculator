...
//             {getCalculationDataValue('account-value') && getCalculationDataValue('account-value') < 50000 && option.title == 'CAAP Small Account Solutions' ? <p className="program-card-error-message">{"Account value does not meet program minimum. Please correct account value to continue."}</p>:''}
//           </label>
//         ))}
//       </div>
//     </div>
      ...
      <div className="program-grid">
        {programOptions.map((option) => (
          <label key={option.id} className="program-card">
            ...
            {selectedOption === option.value && !validateOption(option.value) && (
